...
export class FormContainer extends HTMLElement {
  constructor() {
    ...
    this.addEventListener("form-container:submit:invalid", e => {
      e.detail.changes();
    });

    this.addEventListener("form-container:submit:valid", e => {
      e.detail.changes({
        form: this.getFormDetail()
      });
    });

    this.addEventListener("form-container:reset", e => {
      this.reset();
    });
    ...
    this.addEventListener("submit", e => {
      ...
      this.dispatchFormEvent("form-container:submit:request", {
        form: this.getFormDetail()
      });
    });
